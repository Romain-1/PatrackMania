...
#include "lib/Engine/BaseComponents/RigidBody.h"
...
int main(int argc, char** argv)
{
	...
	auto carRb = car->AddComponent<RigidBody>();
	carRb->rigidBody->setAcceleration(0, -9.81, 0);
	carRb->rigidBody->setDamping(0.9, 0.9);
	carRb->rigidBody->setMass(1);
	...
	cubeRb->boxCollider->halfSize = cyclone::Vector3(100, 5, 100);
